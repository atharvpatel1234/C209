...
def openChatWindow():
    ...
    attach.place(x=10,y=310)

    text_message=Entry(window,text="",width=50,font=("Calibri",10))
    text_message.place(x=100,y=310)

    send=Button(window,text="SEND",font=("Calibri",10),bd=1)
    send.place(x=435,y=310)
  
    filePathlabel=Label(window,text="",fg="blue",font=("Calibri",8))
    filePathlabel.place(x=100,y=330)
